...
public class PricingController {
    ...
    public ResponseEntity<MessageResponse<Pricing_Res_DTO>> updatePricing(
            @Valid @RequestBody Pricing_Req_DTO req , @PathVariable Long prod_id) {
        return ResponseEntity.status(HttpStatus.OK)
            .body(new MessageResponse<>("Product pricing updated successfully.", service.updatePricing(req, prod_id)));
    }
}
